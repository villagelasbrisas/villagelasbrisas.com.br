    ...
    <section id="reservations">
        ...
        <form method="POST" action="<?= INCLUDE_PATH ?>reservas">
            ...
            <div class="input-block">
                ...
                <input type="number" name="adults" id="adults" placeholder="Quantos adultos?" value="0" required>
            </div>
            ...
            <div class="input-block">
                ...
                <input type="number" name="kids" id="kids" placeholder="Quantidade de crianças até 05 anos de idade" value="0">
            </div>
