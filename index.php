<?php include_once('https://www.villagelasbrisas.com.br/template/header.php') ?>
    <main>
        ...
        <section class="galerias">
            ...
            <div class="capas">
                <div class="capa">
                    <a href="galerias/acomodacoes/">
                        <img src="misc/img/box-acomodacoes.jpg" alt="Galeria acomodações">
                        <h3>Acomodações</h3>
                    </a>
                </div>

                <div class="capa">
                    <a href="galerias/lazer/">
                        <img src="misc/img/box-lazer.jpg" alt="Galeria lazer">
                        <h3>Lazer</h3>
                    </a>
                </div>

                <div class="capa">
                    <a href="galerias/restaurante/">
                        <img src="misc/img/box-restaurante.jpg" alt="Galeria restaurante">
                        <h3>Restaurante</h3>
                    </a>
                </div>

                <div class="ver-mais">
                    <a href="galerias/" class="bg-green">Ver mais...</a>
                </div>
            </div>
        </section>
        <!-- Fim: galerias -->
